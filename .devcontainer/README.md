...
`stable/`: Docker image to develop the extension with the stable version of TeX Live. Based on the `trixie` image on [the official Debian](https://hub.docker.com/_/debian).
