...
class PDFViewer {
  ...
  #setScale(value, options) {
    ...
    if (scale > 0) {
      ...
      const pageWidthScale = (this.container.clientWidth - hPadding) / currentPage.width * currentPage.scale / this.#pageWidthScaleFactor * (1 / (1 - (viewerTrim ?? 0) / 100));
      const pageHeightScale = (this.container.clientHeight - vPadding) / currentPage.height * currentPage.scale * (1 / (1 - (viewerTrim ?? 0) / 100));
      switch (value) {
        case "page-actual":
          scale = 1;
          break;
