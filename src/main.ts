...
export function activate(context: vscode.ExtensionContext) {
    ...
    vscode.commands.registerCommand('latex-workshop.build', extension.liveshare.remoteCommand('latex-workshop.build', () => extension.commander.build()))
    ...
    vscode.commands.registerCommand('latex-workshop.kill', extension.liveshare.remoteCommand('latex-workshop.kill', () => extension.commander.kill()))
    ...
    vscode.commands.registerCommand('latex-workshop.clean', extension.liveshare.remoteCommand('latex-workshop.clean', () => extension.commander.clean()))
