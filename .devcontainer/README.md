...
With [VS Code Remote Development](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.vscode-remote-extensionpack), we can develop TeX Workspace Secure in a container by executing `Remote-Containers: Reopen Folder in Container`. See:
