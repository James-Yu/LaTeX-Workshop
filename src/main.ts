...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const foldingProvider    = new FoldingProvider(extension)
    const hoverProvider      = new HoverProvider(extension)
    const definitionProvider = new DefinitionProvider(extension)
    const docSymbolProvider  = new DocSymbolProvider(extension)
    context.subscriptions.push(vscode.languages.registerHoverProvider({ scheme: 'file', language: 'latex'}, hoverProvider))
    context.subscriptions.push(vscode.languages.registerHoverProvider({ scheme: 'file', language: 'tstex'}, hoverProvider))
    context.subscriptions.push(vscode.languages.registerDefinitionProvider({ scheme: 'file', language: 'latex'}, definitionProvider))
    context.subscriptions.push(vscode.languages.registerDefinitionProvider({ scheme: 'file', language: 'tstex'}, definitionProvider))
    context.subscriptions.push(vscode.languages.registerDocumentSymbolProvider({ scheme: 'file', language: 'latex'}, docSymbolProvider))
    context.subscriptions.push(vscode.languages.registerDocumentSymbolProvider({ scheme: 'file', language: 'tstex'}, docSymbolProvider))
    ...
    context.subscriptions.push(vscode.languages.registerCompletionItemProvider({ scheme: 'file', language: 'tstex'}, extension.completer, '\\', '{', ',', '(', '['))
    ...
    context.subscriptions.push(vscode.languages.registerCodeActionsProvider({ scheme: 'file', language: 'tstex'}, extension.codeActions))
    context.subscriptions.push(vscode.languages.registerFoldingRangeProvider({ scheme: 'file', language: 'latex'}, foldingProvider))
    context.subscriptions.push(vscode.languages.registerFoldingRangeProvider({ scheme: 'file', language: 'tstex'}, foldingProvider))
    extension.linter.lintRootFileIfEnabled()
    obsoleteConfigCheck(extension)
